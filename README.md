...
| [`spacex_dash_app.py`](https://github.com/juliasacca/Capstone-IBM-Data-Science-Program/blob/main/spacex_dash_app.py)                              | Dash application that provides an interactive dashboard for SpaceX launch analysis.                     |
